    ...
    <div class="card card-info">
      <div class="card-header">
        ...
        <div class="card-tools">
          <a href="jeniskamar.php" class="btn btn-sm btn-warning float-right"><i class="fas fa-arrow-alt-circle-left"></i> Kembali</a>
        </div>
      </div>
      <!-- /.card-header -->
      <!-- form start -->
      ...
      <?php if((!empty($_GET['notif']))&&(!empty($_GET['jenis']))){?>
        ...
        <?php }?>
      <?php }?>
      <form class="form-horizontal" action="konfirmasieditjeniskamar.php" method="post" enctype="multipart/form-data">
        <div class="card-body">          
