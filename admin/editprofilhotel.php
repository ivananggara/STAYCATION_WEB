      ...
      <form class="form-horizontal">
        <div class="card-body">          
          <div class="form-group row">
            ...
            <i class="fas fa-building"></i> <u>PROFIL HOTEL</u></span></label>
          </div>
          <div class="form-group row">
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-7">
              <input type="text" class="form-control" name="email_hotel" id="email_hotel" value="">
            </div>
          </div>
          <div class="form-group row">
            <label for="kontak_hotel" class="col-sm-3 col-form-label">Kontak Hotel</label>
            <div class="col-sm-7">
              <input type="text" class="form-control" name="kontak_hotel" id="kontak_hotel" value="">
            </div>
          </div>
          <div class="form-group row">
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-7">
              <textarea class="form-control" name="fasilitas" rows="12">Lorem Ipsum</textarea>
            </div>
          </div>
          <div class="form-group row">
