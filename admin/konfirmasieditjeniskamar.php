<?php
    ...
    if(empty($jenis_kamar)){
        header("Location:editjeniskamar.php?data=$id_jenis_kamar&notif=editkosong&jenis=jenis kamar");
    }else if(empty($harga_kamar)){
        header("Location:editjeniskamar.php$id_jenis_kamar&notif=editkosong&jenis=harga kamar");
    }else if(empty($harga_kamar)){
        header("Location:editjeniskamar.php?$id_jenis_kamar&notif=editkosong&jenis=jumlah kamar");
    }else{
