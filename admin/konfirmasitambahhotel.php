<?php
 ...
 if(empty($hotel)){	   
    header("Location:tambahhotel.php?notif=tambahkosong&jenis=hotel");
 }else if(empty($id_user)){
  header("Location:tambahhotel.php?notif=tambahkosong&jenis=admin");
 }else if(empty($id_wisata)){	    
    header("Location:tambahhotel.php?notif=tambahkosong&jenis=wisata");
 }else if(empty($bintang_hotel)){
  header("Location:tambahhotel.php?notif=tambahkosong&jenis=bintang");
 }else if(empty($jarak)){
  header("Location:tambahhotel.php?notif=tambahkosong&jenis=jarak");
 }else if(empty($email)){
    header("Location:tambahhotel.php?notif=tambahkosong&jenis=email");
 }else if(empty($kontak)){
    header("Location:tambahhotel.php?notif=tambahkosong&jenis=kontak");
 }else if(empty($fasilitas)){
    header("Location:tambahhotel.php?notif=tambahkosong&jenis=fasilitas");
 }else if(empty($deskripsi_hotel)){
    header("Location:tambahhotel.php?notif=tambahkosong&jenis=deskripsihotel");
 }else if(!move_uploaded_file($lokasi_gambar_hotel,$direktori_gambar_hotel)){
    header("Location:tambahhotel.php?notif=tambahkosong&jenis=gambarhotel");
 }else if(!move_uploaded_file($lokasi_gambar_interior1,$direktori_gambar_interior1)){
    header("Location:tambahhotel.php?notif=tambahkosong&jenis=gambarinterior1");
 }else if(!move_uploaded_file($lokasi_gambar_interior2,$direktori_gambar_interior2)){
    header("Location:tambahhotel.php?notif=tambahkosong&jenis=gambarinterior2");
 }else if(!move_uploaded_file($lokasi_gambar_interior3,$direktori_gambar_interior3)){
    header("Location:tambahhotel.php?notif=tambahkosong&jenis=gambarinterior3");
 }else if(!move_uploaded_file($lokasi_gambar_interior4,$direktori_gambar_interior4)){
    header("Location:tambahhotel.php?notif=tambahkosong&jenis=gambarinterior4");
 }else{   
  ...
  '$email','$kontak','$nama_gambar_hotel','$nama_gambar_interior1', '$nama_gambar_interior2', '$nama_gambar_interior3', '$nama_gambar_interior4')";
    ...
    header("Location:hotel.php?notif=tambahberhasil");
  }
?>