...
<section style="height: 100vh;" class="w-100 my-auto">
    <div class="container px-5"style="padding: 5% 0;">
        <div class="kotak m-auto w-100"> 
            <div class=" close position-absolute" style="z-index: 99; margin: -25px 0 0 -30px;">
                <a href="index.php"><img src="assets/img/close.png" width="50px"alt=""></a>
            </div>
            <div class="row">
                    ...
                    <div class="kotak-sign m-auto ">
                        ...
                        <form>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="password" class="form-control input-password" style="padding: 14px; background-color: #F4F4F4; margin-bottom: 70px;" id="exampleInputPassword1" placeholder="put your password here">
                            </div>
